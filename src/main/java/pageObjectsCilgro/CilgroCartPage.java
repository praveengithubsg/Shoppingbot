...
public class CilgroCartPage extends CucumberRunnerCilgro {
	/**
	 * Class object declaration here
	 **/
	CommonMethods commonMethods = new CommonMethods();
	WaitHelper waitHelper = new WaitHelper();
	CilgroLoginPage login=new CilgroLoginPage();
	private Logger log = Logger.getLogger(CilgroCartPage.class.getName());

	/**
	 * Constructor to initialize page objects
	 **/
	public CilgroCartPage() {
